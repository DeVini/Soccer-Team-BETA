...
public class ReportUtil implements Serializable{
	...
	public StreamedContent geraRelatorio(List<?> listDataBeanColletionReport,
		...
		String caminhoRelatorio =  scontext.getRealPath(FOLDER_RELATORIOS).replaceAll("WebContent", "src");
				
				//"C:\\Users\\nyroc\\git\\Soccer-Team-BETA\\Soccer Team BETA\\src\\relatorios\\"; //this.getClass().getResource("./").toString();      //scontext.getRealPath(FOLDER_RELATORIOS);
		
		// EX: -> c:/aplicação/relatorios/rel_bairo.jasper
		File file = new File(caminhoRelatorio + SEPARATOR + nomeRelatorioJasper + PONTO + "jasper");
	
		//getClass().getResourceAsStream("../relatorios/default.jasper").toString();
		//File f = new File(); 	
		...
		parametrosRelatorio.put("REPORT_PARAMETERS_IMG", caminhoRelatorio+SEPARATOR);
