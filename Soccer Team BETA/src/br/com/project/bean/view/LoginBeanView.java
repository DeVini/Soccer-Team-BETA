...
public class LoginBeanView extends BeanManagedViewAbstract {
	...
	public void invalidarSessionMetodo(HttpServletRequest httSevletRequest) throws Exception
	{
		
		String userLogadoSessao = null;
		if(httSevletRequest.getUserPrincipal() != null){
			userLogadoSessao = httSevletRequest.getUserPrincipal().getName();
		}
		
		if(userLogadoSessao == null ||(userLogadoSessao != null && userLogadoSessao.trim().isEmpty())){
			userLogadoSessao = httSevletRequest.getRemoteUser();
		}
